...
class UpdateGalleryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'video_url' => 'required_if:type,video|url', // Video URL required if type is video
            'sorting_index' => 'sometimes|integer|min:0', // Sorting index is optional in update
            'status' => 'required|in:1,2', // Status is still required
        ];
    }
